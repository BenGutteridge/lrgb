...
python main.py --cfg configs/SAN/vocsuperpixels-SAN.yaml tensorboard_each_run True dataset.dir ../../lrgb/datasets wandb.use False train.ckpt_period 10 device cuda train.auto_resume True out_dir results/retry
