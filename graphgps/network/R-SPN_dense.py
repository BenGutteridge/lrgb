...
class RSPN_dense(nn.Module):
    ...
    def __init__(self, dim_in, dim_out):
        ...
        for t in range(cfg.gnn.layers_mp):
            layers.append(RSPN_denseConvLayer(dim_in))
...
register_network('R-SPN_dense', RSPN_dense)

class RSPN_denseConvLayer(nn.Module):
    """
    ...
    def __init__(self, hidden_dim):
        ...
        all_modules = dict(gin_nn_post=gin_nn_post, # making an attr of the module so it shows in model summary (hopefully)
                            ...
                            mlp_k=mlp_k,
                            mlp_e=mlp_e)
        self.model = RSPN_denseConv(all_modules)
...
class RSPN_denseConv(MessagePassing):
    ...
    def __init__(self, modules: nn.ModuleDict,
        ...
        super(RSPN_denseConv, self).__init__(**kwargs)
