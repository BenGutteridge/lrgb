...
def join_list(l1, l2):
    try:
        assert len(l1) == len(l2), \
            ...
            l1: results[split]: {'train': None, 'val': None, 'test': None}[split]
            l2: stats_list: stats_list = json_to_dict_list(fname_stats), then stats_list = [[stats] for stats in stats_list]

            If results[split] is not None, then it is this function is run.
            """
    except:
        print('l1:\n', l1)
        print('l2:\n', l2)
