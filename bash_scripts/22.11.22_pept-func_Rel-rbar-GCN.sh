...
for run in "${runs[@]}" ; do
  ...
  python main.py --cfg "$run" --repeat 1 device cuda dataset.dir dataset.dir /data/beng/datasets "results/$BATCH" optim.max_epoch 300 use_edge_labels True gnn.stage_type rel_delay_gnn
