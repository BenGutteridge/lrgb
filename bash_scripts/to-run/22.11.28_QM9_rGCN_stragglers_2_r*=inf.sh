#!/bin/bash
cd ..
BATCH="22.11.28_QM9_rGCN_stragglers_1_r*=inf_d=064.sh"
...
for run in "${runs[@]}" ; do
  ...
  python main.py --cfg "$run" --repeat 1 rbar -1 device cuda dataset.dir datasets out_dir "results/$BATCH" optim.max_epoch 300 train.batch_size 1024 gnn.dim_inner 64
