#! /bin/bash
#SBATCH --job-name=PFmaxL11nu1lap
#SBATCH --nodes=1
...
python3.9 main.py --cfg "$file" --repeat 3 jk_mode 'max' fixed_params.N 500_000 rho $rho gnn.layer_type $layer out_dir $out_dir device cuda dataset.dir "$dir" nu $nu gnn.layers_mp $L optim.max_epoch 300 tensorboard_each_run True train.mode my_custom
