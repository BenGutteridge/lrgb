...
bash 22.12.06_jade_pept-func_rbar=01.sh "$L" &
      ...
      bash 22.12.06_jade_pept-func_rbar=01.sh "$((L+10))" &
      bash 22.12.06_jade_pept-func_rbar=03.sh "$((L+10))" &
      bash 22.12.06_jade_pept-func_rbar=half_L.sh "$((L+10))" &
      bash 22.12.06_jade_pept-func_rbar=inf.sh "$((L+10))" &
      bash 22.12.06_jade_pept-func_rbar=L-2.sh "$((L+10))" &
      bash 22.12.06_jade_pept-func_alpha.sh "$((L+10))"
