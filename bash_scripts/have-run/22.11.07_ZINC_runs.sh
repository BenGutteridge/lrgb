...
configs/rbar-GCN/ZINC-rGCN_L=11_d=085_r=01.yaml
configs/rbar-GCN/ZINC-rGCN_L=11_d=085_r=inf.yaml
configs/rbar-GCN/ZINC-rGCN_L=13_d=070_r=01.yaml
configs/rbar-GCN/ZINC-rGCN_L=13_d=070_r=inf.yaml

configs/GCN/ZINC-GCN_L=02_d=500.yaml
configs/GCN/ZINC-GCN_L=05_d=300.yaml
configs/rbar-GCN/ZINC-rGCN_L=05_d=175_r=02.yaml
configs/rbar-GCN/ZINC-rGCN_L=05_d=175_r=03.yaml
configs/rbar-GCN/ZINC-rGCN_L=07_d=130_r=02.yaml
configs/rbar-GCN/ZINC-rGCN_L=07_d=130_r=03.yaml
configs/rbar-GCN/ZINC-rGCN_L=07_d=130_r=05.yaml
configs/rbar-GCN/ZINC-rGCN_L=09_d=100_r=02.yaml
configs/rbar-GCN/ZINC-rGCN_L=09_d=100_r=05.yaml
)
for run in "${runs[@]}" ; do
