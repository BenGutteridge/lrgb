...
python main.py --cfg "$file" --repeat 3 device cuda dataset.dir "$dir" nu -1 gnn.layers_mp $L optim.max_epoch 300 gnn.dim_inner $d tensorboard_each_run False train.mode my_custom
python main.py --cfg "$file" --repeat 3 device cuda dataset.dir "$dir" nu 1 gnn.layers_mp $L optim.max_epoch 300 gnn.dim_inner $d tensorboard_each_run False train.mode my_custom